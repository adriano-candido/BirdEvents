            ...
            <div class="row">
                <?php if (isset($usuario)): ?>
                    <div class="input-field col s12">
                        ...
                        <input type="text" class="validate" name="nome" value="<?= $usuario->getUsuario()->getNome(); ?>" <?= $disabled; ?>>
                ...
                <div class="row">
                    <div class="input-field col s6">
                        ...
                        <input type="text" class="validate cpf" name="cpf" value="<?= $usuario->getUsuario()->getCpf(); ?>" <?= $disabled; ?>>
                        <label >CPF</label>
                    </div>

                    <div class="input-field col s6">
                        <i class="material-icons prefix">lock</i>
                        <input  type="text" class="validate" name="senha" value="<?= $usuario->getUsuario()->getSenha(); ?>" <?= $disabled; ?>>
                        <label >Senha</label>
                    </div>
                </div>
                                ...
                                <?php foreach ($permissao as $opcao) : ?>
                                    <li class="collection-item">
                                        ...
                                        foreach ($permissoesVinculadas as $permissaoVinculada) :
                                            if ($permissaoVinculada->getPermissao() == $opcao['string']) {
                                                echo 'checked';
                                                break;
                                            }
                                        endforeach;
